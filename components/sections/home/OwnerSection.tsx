      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-8 max-w-7xl mx-auto">
          ...
          <motion.div 
            ...
            className="glass-card relative p-8 md:p-8 rounded-3xl overflow-hidden group flex flex-col h-full"
          >
            ...
            <div className="flex flex-col items-center text-center">
              <div className="relative w-48 h-64 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/5 mb-8 transform transition-transform group-hover:scale-105 duration-500">
                <Image src="/images/Owner.jpeg" alt="Rtn. J. Balamurugan" fill className="object-cover" />
              </div>
              
              <h3 className="text-2xl font-bold mb-2">Rtn. J. Balamurugan</h3>
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              <div className="relative w-48 h-64 rounded-2xl overflow-hidden shadow-2xl border-4 border-amber/20 mb-8 transform transition-transform group-hover:scale-105 duration-500">
                <Image src="/images/owner 2.jpeg" alt="J Anand" fill className="object-cover" />
              </div>
              
              <h3 className="text-2xl font-bold mb-2">J Anand</h3>
              <div className="text-amber font-medium tracking-wide uppercase text-sm mb-6 pb-4 border-b border-white/10 inline-block px-4">
                Co-Founder
              </div>
              
              <p className="text-white/70 leading-relaxed max-w-sm">
                Committed to delivering comprehensive driving instruction and expanding our school's vision.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="glass-card relative p-8 md:p-8 rounded-3xl overflow-hidden group flex flex-col h-full"
          >
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-amber/5 rounded-full blur-3xl translate-y-1/2 translate-x-1/4 pointer-events-none group-hover:bg-amber/10 transition-colors duration-500" />
            
            <div className="flex flex-col items-center text-center">
              <div className="relative w-48 h-64 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/5 mb-8 transform transition-transform group-hover:scale-105 duration-500">
                <Image src="/images/owner 3.jpeg" alt="J Balraj" fill className="object-cover" />
              </div>
              
              <h3 className="text-2xl font-bold mb-2">J Balraj</h3>
              <div className="text-amber font-medium tracking-wide uppercase text-sm mb-6 pb-4 border-b border-white/10 inline-block px-4">
                Co-Founder
              </div>
              
              <p className="text-white/70 leading-relaxed max-w-sm">
                Ensuring operational excellence and student success through dedicated management.
              </p>
            </div>
          </motion.div>
        </div>
